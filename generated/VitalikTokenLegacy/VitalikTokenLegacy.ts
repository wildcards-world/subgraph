...
export class VitalikTokenLegacy extends SmartContract {
  static bind(address: Address): VitalikTokenLegacy {
    return new VitalikTokenLegacy("VitalikTokenLegacy", address);
  }
