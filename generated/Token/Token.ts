...
export class Token extends SmartContract {
  ...
  mintWithTokenURI(to: Address, tokenId: BigInt, tokenURI: string): boolean {
    let result = super.call("mintWithTokenURI", [
      EthereumValue.fromAddress(to),
      EthereumValue.fromUnsignedBigInt(tokenId),
      EthereumValue.fromString(tokenURI)
    ]);
  ...
  try_mintWithTokenURI(
    ...
    let result = super.tryCall("mintWithTokenURI", [
      EthereumValue.fromAddress(to),
      EthereumValue.fromUnsignedBigInt(tokenId),
      EthereumValue.fromString(tokenURI)
    ]);
...
export class MintWithTokenURICall extends EthereumCall {
