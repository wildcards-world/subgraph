...
export class Contract__patronageOwedWithTimestampResult {
  value0: BigInt;
  value1: BigInt;
...
export class VitalikStewardLegacy extends SmartContract {
  static bind(address: Address): VitalikStewardLegacy {
    return new VitalikStewardLegacy("Contract", address);
  }
  ...
  patronageOwedWithTimestamp(): Contract__patronageOwedWithTimestampResult {
    let result = super.call("patronageOwedWithTimestamp", []);

    return new Contract__patronageOwedWithTimestampResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_patronageOwedWithTimestamp(): CallResult<
    Contract__patronageOwedWithTimestampResult
  > {
    ...
    return CallResult.fromValue(
      new Contract__patronageOwedWithTimestampResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
